...
var select = document.getElementById("chusertype");
var chusertype = select.options[select.selectedIndex].value;
...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >用户类型管理</th>

  </tr>
<td class="CPanel">
<table width="100%" height="245" border="0" cellspacing="0"  >
<tr style="border:1px solid black; padding:20px; width:100%;">
  <th style="border:1px solid black; padding:20px; width:33%;" align="center" valign="top" cellpadding="0" cellspacing="0" ><h2 align="center">更改用户类型</h2>
    <form id="change1" name="change1" method="post" action="/files/manusertype.jsp?username=<%=UserName%>">
    <p>
    ...
    <p>
      <label for="chusertype">类 &nbsp; 型:</label>
      <select name="chusertype" id="chusertype">
  ...
  <th style="border:1px solid black; padding:20px; width:33%;"><h2 align="center">添加用户类型</h2>
      <form id="change2" name="change2" method="post" action="/files/manusertype.jsp?username=<%=UserName%>">
    <p>
...
<% ResultSet rs2=data.executeQuerydate(sql); %>
  ...
  <th style="border:1px solid black; padding:20px; width:33%;" width="33%"><h2 align="center">删除用户类型</h2>
      <form id="change3" name="change3" method="post" action="/files/manusertype.jsp?username=<%=UserName%>">
    <p>
