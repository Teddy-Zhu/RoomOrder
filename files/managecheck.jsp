...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >管理预约信息</th>

  </tr>
  <td align="center" class="CPanel">
预约者
    <input  type="text"  id="yyusername"/>
预约时间
    <input  type="text"  onclick="WdatePicker()" class="Wdate" readonly="readonly" id="date"/>
	申请时间
    <input  type="text"  onclick="WdatePicker()" class="Wdate" readonly="readonly" id="sqdate"/><br/>
		教室类型
...
预约状态
<%
ResultSet rs =data.executeQuerydate("select * from statustype");
%>
<select id="enable" name="enable">
  <option value="0">所有申请</option>
  <%
while(rs.next()){
%>
...
<input style="vertical-align:middle" type="button" class="btn btn-green big" value="查询" onclick="query(3,1,'<%=UserName%>')"/>
<br><br>
