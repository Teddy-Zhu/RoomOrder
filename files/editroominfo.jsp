...
if ( n==1){
String sql="update roombasicinfo set roomtype='" +roomtype +"',examecount='" +examecount +"',roomcount='" +roomcount +"'  where roomlocal='" + roomlocal+"'";
...
String crsql="更新了教室"+roomlocal+"的基本数据.";
